...
public class Item {
    ...
    private double cost;
    public Item(int item_code,String item_description,int qty_in_stock,int min_required_stock,double cost){
    ...
    public Item(int item_code,int qty_in_stock,int min_required_stock,double cost){
        this.item_code = item_code;
        this.qty_in_stock = qty_in_stock;
        this.min_required_stock = min_required_stock;
        this.cost = cost;
