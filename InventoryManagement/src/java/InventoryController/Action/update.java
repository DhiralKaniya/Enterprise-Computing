 ...
 * @author dhiral
 */
public class update implements ActionInterface{
    ...
    public String actionPerfrom(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        try{
            ...
            InventoryItem myitem = new InventoryItem(item_code,item_description,qty,mr,cost,cateid);
            invDAO.updateitem(myitem);
            InventoryItem[] myitem1 = invDAO.getItem();
            InventoryCategory[] mycate = invDAO.viewCategory();
            request.setAttribute("myitem", myitem1);
