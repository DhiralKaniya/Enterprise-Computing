...
public class InventoryItem {
    ...
    public InventoryItem(int item_code,String item_description,int qty_in_stock,int min_required_stock,double cost,int category){
        ...
        this.min_required_stock = min_required_stock;
        this.cost = cost;
        this.category = new InventoryCategory(category);
    }
